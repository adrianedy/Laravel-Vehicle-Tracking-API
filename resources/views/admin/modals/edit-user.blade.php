<div class="modal fade" tabindex="-1" role="dialog" id="modal-edit-user">
    ...
    <div class="modal-content">
      <form class="ajax-form" enctype="multipart/form-data" method="post">
        ...
        <div class="modal-body">
          ...
          <div class="form-row">
            <div class="form-group col-md-6">
              <label class="required">New PIN</label>
              <input type="password" class="form-control mb-1 pin" name="pin" maxlength="5">
            </div>
            <div class="form-group col-md-6">
              <label class="required">Confirm New PIN</label>
              <input type="password" class="form-control mb-1 pin" name="pin_confirmation" maxlength="5">
            </div>
          </div>
          <div class="form-group">
            <div class="custom-control custom-checkbox">
              <input type="checkbox" class="custom-control-input" name="active" id="editUserActive">
              <label class="custom-control-label" for="editUserActive">Active</label>
            </div>
          </div>
        </div>
